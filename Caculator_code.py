...
window = tk.Tk()
window.title('SIMPLE_CALCULATOR')
...
button_mul.grid(row = 5, column = 2, pady = 2)
...
button_clean = tk.Button(master = frame, text = "clean", padx = 15, pady = 5, width = 3, command = clean)
button_clean.grid(row = 6, column = 1, pady = 2)
